...
function TransferModal() {
  ...
  return (
    <>
      <input defaultChecked type="checkbox" id="transferModal" className="modal-toggle hidden" />
        ...
        <div className="modal-box max-w-[1000px] h-full">
          ...
          {page === 1 && (
            <div className={"mb-4"}>
              ...
              <h4 className="text-lg font-medium text-gray-700 mt-4 mb-2">{t(k.SELECT_LANG)}</h4>
              <div className={"mb-4"}>
                <LanguageSelect />
              </div>
              <iframe
          ...
          {page === 2 && (
            <div className="p-4">
              ...
              <p className="text-gray-600 mb-4">{t(k.YOU_NOW_GET_TO_PICK_YOUR_OWN_C)}</p>

              <Head4>{t(k.USE_AI_PROMPT_GENIUS_ANYWHERE)}</Head4>
              <p className="text-gray-600 mb-4">{t(k.AI_PROMPT_GENIUS_IS_NOW_SELF_C)}</p>
          ...
          <div className={"absolute bottom-0 mb-2 p-3"}>
            <button disabled={page === 1} className={"btn mr-3 disabled:hidden"} onClick={prevPage}>
              {t(k.BACK)}
            </button>
            <button
