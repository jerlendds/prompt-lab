      ...
      >
        <div className="mainClick z-0 card-body flex flex-row p-4 justify-between align-top">
          ...
          <div className={`mainClick buttons flex ${compactBtnClass}`}>
            <button onClick={showModal} className="edit my-1 border-none btn p-1 bg-inherit">
              <EditIcon></EditIcon>
            </button>
            <button
              ...
              <div>
                ...
                <div className="flex flex-wrap mb-2">
                  {template.tags &&
                    // eslint-disable-next-line react/prop-types
                    tags.map((tag, i) => (
                      <RemoveTag tag={tag} key={i} onClick={() => removeTag(tag)}></RemoveTag>
                    ))}
                </div>
                <input
        ...
        <>
          ...
          <div className="modal" role="dialog">
            <div className="modal-box">
              ...
              <div className="modal-action">
                <label htmlFor={`delete_prompt_modal_${template.id}`} className="btn">
                  {t(k.CANCEL)}
                </label>
                <label
