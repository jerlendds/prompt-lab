...
export default function HotkeyUpdateModal() {
  ...
  return (
    <>
      <input defaultChecked type="checkbox" id="hotkeyModal" className="modal-toggle hidden" />
      <div className="modal">
        <div className="modal-box max-w-[1000px] h-full">
          <Logo className="w-20 h-20 mx-auto my-4"> </Logo>
          <div className={"mb-4 p-4"}>
            <Head2>Hotkey is back!</Head2>
            <Head4>Access your prompts with a customizable hotkey shortcut on any page.</Head4>
            ...
            <p className={"my-2"}>
              ...
              and choose a shortcut for "Launch Search" under AI Prompt Genius. Then use that
              shortcut on any page, for example, ChatGPT.
            </p>
            <Head2>Give your feedback for a chance to win a $50 Amazon.com gift card</Head2>
            <p className={"mb-3"}>
              <a
              ...
              in a survey about the future of AI Prompt Genius (English only). Your feedback is much
              appreciated!
            </p>
            <Head2>Acknowledgement of outage</Head2>
            <p>
              We'd like to apologize for any disruption that may have occurred Tuesday the 12th. As
              always, you can reach out to aipromptgenius@gmail.com for support.
            </p>
          </div>
